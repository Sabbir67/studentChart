...
$sql = "SELECT semester ,COUNT(*) AS cc FROM studentt WHERE university='AIUB' GROUP BY semester";
$sql2 ="SELECT semester ,COUNT(*) AS cc FROM studentt WHERE university='NSU' GROUP BY semester";
