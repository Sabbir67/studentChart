...
$sql = "SELECT year,Count(*) AS cc FROM studentt WHERE university='NSU' GROUP BY year";
$sql2 ="SELECT year,Count(*) AS cc FROM studentt WHERE university='BRAC' GROUP BY year";
